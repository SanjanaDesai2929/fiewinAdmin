...
const Addtask = () => {
    ...
    const handleClick = async () => {
        ...
        //validation
        if (!task || !description || !points || !status || !order || !type || !range || !image) {
            ...
            data: localStorage.getItem('Auth_token')
                ...
                if (res.status === 200) {
                    console.log('done');
                    toast.success('Add Task Reword Successfully', {
                        position: toast.POSITION.TOP_CENTER,
                        autoClose: 1000,
                    });
                    setTimeout(() => {
                ...
                if (res.status === 400) {
                    toast.success('Please Fill The All Required Filled ', {
                        position: toast.POSITION.TOP_CENTER,
                        autoClose: 1000,
                    });
            ...
            <main id="main" className="main">
                ...
                <div className="pagetitle">
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <h1><span style={{ marginRight: '-2px' }}><i className="bi bi-file-earmark-plus"></i>   </span> Add Task</h1>
                            ...
                            <div style={{ opacity: 0.8, color: '#012970', marginTop: '7px' }}>
                                ...
                                <span style={{ opacity: 0.8, color: '#012970' }} > <b><span><i className="bi bi-file-earmark-plus"></i></span><span> Add Task    </span></b></span>
                            </div>
                        </div>
                                                    ...
                                                    <div className="card-body p-md-5">
                                                        <div className="row justify-content-center">
                                                            <div className="col-md-10 col-lg-6 col-xl-7 order-2 order-lg-1">
                                                                ...
                                                                <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add Task Reword</p>

                                                                <form className="mx-1 mx-md-4">

                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example1c"><span style={{ color: 'red' }}>*</span>  Task</label>
                                                                    ...
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> Description </label>
                                                                            <textarea type="text" id="form3Example3c" className="form-control" value={description} onChange={(e) => { setDescription(e.target.value) }} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> Order </label>
                                                                            <input type="number" id="form3Example3c" className="form-control" value={order} onChange={(e) => { setOrder(e.target.value) }} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> points </label>
                                                                            <input type="number" id="form3Example3c" className="form-control" value={points} onChange={(e) => { setPoints(e.target.value) }} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> range </label>
                                                                            <input type="number" id="form3Example3c" className="form-control" value={range} onChange={(e) => { setRange(e.target.value) }} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> type </label>
                                                                            <input type="text" id="form3Example3c" className="form-control" value={type} onChange={(e) => { setType(e.target.value) }} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> status </label>
                                                                            <select name="cars" id="cars" className="form-control" onChange={(e) => { setStatus(e.target.value) }}>
                                                                    ...
                                                                    <div className="d-flex flex-row align-items-center mb-4">
                                                                        <div className="form-outline flex-fill mb-0">
                                                                            <label className="form-label" for="form3Example3c"><span style={{ color: 'red' }}>*</span> Image </label>
